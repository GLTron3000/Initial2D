...
CFLAGS  = $$(pkg-config gtk+-3.0 --cflags) -Wall -std=gnu99 -pedantic -O2
LIBS    = $$(pkg-config gtk+-3.0 --libs) -lm -lpthread

# Mettre ici la liste des fichiers .c separes par un espace ;
# si besoin on peut eclater la liste sur plusieurs lignes avec "\".
CFILES  = main-app.c font.c curve.c utils.c mydata.c gui.c area1.c menus.c game.c main_menu.c file.c server.c client.c LAN_menu.c LANC.c
